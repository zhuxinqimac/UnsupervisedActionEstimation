...
# --- File Name: shapes3d_paired.py
# --- Creation Date: 22-05-2021
# --- Last Modified: Sat 22 May 2021 22:05:54 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
Dataset for paired 3D Shapes. Generated from navigator M of stylegan2.
"""
...
class PairedShapes3dStylegan(Dataset):
    """
    Args:
        root (str): Root directory of dataset containing paired_3dshapes.h5
    ...
    def __init__(self, root, transform=None):
        ...
        self.images_orig = self.dataset_zip['images_orig'][:]  # array shape [240000,64,64,3], uint8 in range(256)
        self.images_edit = self.dataset_zip['images_edit'][:]  # array shape [240000,64,64,3], uint8 in range(256)
    ...
    def load_data(self):
        root = os.path.join(self.file, "paired_3dshapes.h5")
